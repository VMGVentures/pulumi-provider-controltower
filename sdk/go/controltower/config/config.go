...
func GetRegion(ctx *pulumi.Context) string {
	return config.Get(ctx, "controltower:region")
}
...
func GetSecretKey(ctx *pulumi.Context) string {
	return config.Get(ctx, "controltower:secretKey")
}
...
func GetSharedCredentialsFile(ctx *pulumi.Context) string {
	return config.Get(ctx, "controltower:sharedCredentialsFile")
}
...
func GetSkipCredentialsValidation(ctx *pulumi.Context) bool {
	return config.GetBool(ctx, "controltower:skipCredentialsValidation")
}
...
func GetSkipMetadataApiCheck(ctx *pulumi.Context) bool {
	return config.GetBool(ctx, "controltower:skipMetadataApiCheck")
}
...
func GetSkipRequestingAccountId(ctx *pulumi.Context) bool {
	return config.GetBool(ctx, "controltower:skipRequestingAccountId")
}
...
func GetToken(ctx *pulumi.Context) string {
	return config.Get(ctx, "controltower:token")
}
