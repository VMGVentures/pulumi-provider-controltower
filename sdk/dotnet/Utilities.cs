...
namespace Pulumi.Controltower
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Controltower.version.txt");
    ...
    internal sealed class ControltowerResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public ControltowerResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
