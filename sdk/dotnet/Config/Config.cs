...
namespace Pulumi.Controltower
{
    public static class Config
    {
        ...
        private static readonly Pulumi.Config __config = new Pulumi.Config("controltower");
        ...
        private static readonly __Value<Pulumi.Controltower.Config.Types.AssumeRole?> _assumeRole = new __Value<Pulumi.Controltower.Config.Types.AssumeRole?>(() => __config.GetObject<Pulumi.Controltower.Config.Types.AssumeRole>("assumeRole"));
        /// <summary>
        /// Settings for making use of the AWS Assume Role functionality.
        /// </summary>
        public static Pulumi.Controltower.Config.Types.AssumeRole? AssumeRole
        {
            get => _assumeRole.Get();
